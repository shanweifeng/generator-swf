...
public class SqlReservedWords {
    ...
    static {
        String[] words = { "A", "ABORT", "ABS", "ABSOLUTE", "ACCESS", "ACTION", "ADA", "ADD", "ADMIN", "AFTER",
                ...
                "ASSOCIATE", "ASUTIME", "ASYMMETRIC", "AT", "ATOMIC", "ATTRIBUTE", "ATTRIBUTES", "AUDIT", "AUTHORIZATION", "AUTO_INCREMENT",
                "AUX", "AUXILIARY", "AVG", "AVG_ROW_LENGTH", "BACKUP", "BACKWARD", "BEFORE", "BEING", "BERNOULLI", "BETWEEN",
                "BIGINT", "BINARY", "BIT", "BIT_LENGTH", "BITVAR", "BLOB", "BOOL", "BOOLEAN", "BOTH", "BREADTH",
                "BREAK", "BROWSE", "BUFFERPOOL", "BULK", "BY", "C", "CACHE", "CALL", "CALLED", "CAPTURE",
                "CARDINALITY", "CASCADE", "CASCADED", "CASE", "CAST", "CATALOG", "CATALOG_NAME", "CCSID", "CEIL", "CEILING",
                "CHAIN", //$NON-NLS-1$
                "CHANGE", //$NON-NLS-1$
                "CHAR", // DB2 //$NON-NLS-1$
