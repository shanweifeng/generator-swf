...
public class PropertyRegistry {
    ...
    public static final String CONTEXT_AUTO_DELIMITE_KEYWORDS = "autoDelimitKeywords";
    ...
    public static final String COMMENT_GENERATOR_SUPPRESS_ALL_COMMENTS = "suppressAllComment";
